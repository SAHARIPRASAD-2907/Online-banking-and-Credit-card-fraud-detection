	...
	if(! isset($_SESSION['user_id'])) { ?>
	  ...
	  <h1 style="height: 150px" class="w3-margin-top w3-padding-32 w3-blue w3-lobster w3-center w3-container">
			...
			<div class="w3-margin-top w3-bottom-middle w3-large w3-bar w3-black">
			  ...
			  <a href="creditcard_index.php" class="w3-bar-item w3-button w3-mobile">Credit Card Fraud Detector</a>
			</div>
		</h1>
	  <div class="lef">
	        ...
	        <img class="mySlides" src="images/bank-5.jpg" >
					...
					<div class="flip-box-inner">
						<div class="flip-box-front">
							<img src="img_paris.jfif" alt="Paris" style="width:300px;height:500px">
						</div>
...
<?php
	...
	echo '<img style="float:left;display:inline-block;height:150px;width:150px;border:1px solid black;margin-top:0px;" src="log.jpg" alt="KVR Logo" title="KVR">';
