...
<body>
  ...
  <?php
    ...
    echo '<img style="float:left;display:inline-block;height:150px;width:150px;border:1px solid black;margin-top:0px;" src="log.jpg" alt="KVR" title="KVR">';
  ...
  <div class="split left">
  	...
  	<div class="home">
		...
		<div class="home">
  		<a href="creditcard_index.php">Fraud detection</a>
  	</div>
